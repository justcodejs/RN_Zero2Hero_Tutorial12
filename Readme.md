# JustCode - React Native Zero to Hero Tutorial 12
Hi! Welcome to JustCode React Native Zero to Hero Tutorial 12 Github page. To run the application in this Github page you need to:
